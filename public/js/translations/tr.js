...
window.translations.tr = {
    ...
    loadPreset: "Ön ayarı forma yükle",
    load: "Yükle",
    ...
    unsavedChangesMessage: "Mevcut yapılandırmanız kayıtlı herhangi bir ön ayarla eşleşmiyor. Değiştirirseniz, mevcut kaydedilmemiş ayarlarınız kaybolacaktır.",
    ...
    // JS'den Sabitlenmiş Dizeler (Hata Mesajları)
    ...
    noPresetSelected: "Hiçbir ön ayar seçilmedi",
    ...
    fieldUpdated: "{displayName} şuna güncellendi: {value}",
    failedToUpdateField: "{displayName} güncellenemedi",

    // validators.js'den Doğrulama Mesajları
    ...
    mustBeTrueOrFalse: "Değer doğru (true) veya yanlış (false) olmalıdır",
