...
export class HybridStrategy extends BaseStrategy {
    ...
    #getCandidates(accounts, modelId) {
        ...
        for (let index = 0; index < accounts.length; index++) {
            ...
            // If it passes basic usability, it's at least a last resort
            ...
            // If it has tokens (bypassing health), it's an emergency candidate
            ...
            // If it is healthy and has tokens, it's a fallback candidate (critical quota)
