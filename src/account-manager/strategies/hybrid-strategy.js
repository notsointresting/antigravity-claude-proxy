...
export class HybridStrategy extends BaseStrategy {
    ...
    selectAccount(accounts, modelId, options = {}) {
        ...
        // Score candidates and find the best in a single pass
        let best = null;
    ...
    #getCandidates(accounts, modelId) {
        ...
        // Single pass over accounts to bucket them appropriately
        for (let index = 0; index < accounts.length; index++) {
            ...
            // If it passes all checks, it's a primary candidate
