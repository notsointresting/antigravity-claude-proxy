...
export class HybridStrategy extends BaseStrategy {
    ...
    #getCandidates(accounts, modelId) {
        ...
        // Evaluate all accounts in a single pass to avoid multiple array allocations and iterations
        for (let i = 0; i < accounts.length; i++) {
            ...
            // Passes usability -> goes to lastResort
            ...
            // Passes usability & tokens -> goes to emergency
            ...
            // Passes usability, tokens & health -> goes to fallback (quota ignored)
            ...
            // Passes ALL checks -> goes to normal
