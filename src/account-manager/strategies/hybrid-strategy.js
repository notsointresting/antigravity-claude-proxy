...
export class HybridStrategy extends BaseStrategy {
    ...
    selectAccount(accounts, modelId, options = {}) {
        ...
        // Score candidates and find the best in O(n)
        let best = { ...candidates[0], score: this.#calculateScore(candidates[0].account, modelId) };
    ...
    #getCandidates(accounts, modelId) {
        ...
        for (let i = 0; i < accounts.length; i++) {
            ...
            // Basic usability check (applies to all levels)
