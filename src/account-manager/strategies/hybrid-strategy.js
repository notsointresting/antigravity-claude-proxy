...
export class HybridStrategy extends BaseStrategy {
    ...
    #getCandidates(accounts, modelId) {
        ...
        for (let index = 0; index < accounts.length; index++) {
            ...
            // At this point, it passes basic usability -> qualifies for lastResort
            ...
            // At this point, it passes basic + tokens -> qualifies for emergency
            ...
            // At this point, it passes basic + tokens + health -> qualifies for quota fallback
            ...
            // At this point, it passes all checks -> qualifies for normal candidate
