...
export class HybridStrategy extends BaseStrategy {
    ...
    #getCandidates(accounts, modelId) {
        ...
        for (let index = 0; index < accounts.length; index++) {
            ...
            // If usable, it qualifies for lastResort (bypasses health and tokens)
            ...
            // If it has tokens, it qualifies for emergency (bypasses health)
            emergency.push(item);
            ...
            // If it's healthy, it qualifies for fallback (ignores quota)
            fallback.push(item);
