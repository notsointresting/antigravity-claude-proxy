...
export class HybridStrategy extends BaseStrategy {
    ...
    selectAccount(accounts, modelId, options = {}) {
        ...
        // Find the best candidate in a single pass without sorting
        let best = null;
    ...
    #getCandidates(accounts, modelId) {
        ...
        for (let index = 0; index < accounts.length; index++) {
            ...
            // Last resort: usable but might lack health and tokens
            ...
            // Emergency: usable and has tokens, but might be unhealthy
            ...
            // Fallback: usable, has tokens, and is healthy (but might have critical quota)
