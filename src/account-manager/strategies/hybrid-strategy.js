...
export class HybridStrategy extends BaseStrategy {
    ...
    selectAccount(accounts, modelId, options = {}) {
        ...
        // Score candidates and track the best in a single pass (O(N) instead of O(N log N))
        let best = null;
    ...
    #getCandidates(accounts, modelId) {
        ...
        // Single-pass evaluation of all fallback levels to avoid multiple array iterations and allocations
        for (let i = 0; i < accounts.length; i++) {
            ...
            // Last resort: basic usability passed
            ...
            // Quota fallback: requires health
