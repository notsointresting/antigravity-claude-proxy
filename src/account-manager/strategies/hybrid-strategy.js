...
export class HybridStrategy extends BaseStrategy {
    ...
    selectAccount(accounts, modelId, options = {}) {
        ...
        // Score candidates and track the best in a single pass O(n)
        let best = null;
    ...
    #getCandidates(accounts, modelId) {
        ...
        // Single pass categorization to avoid multiple map/filter allocations
        for (let index = 0; index < accounts.length; index++) {
            ...
            const isQuotaCritical = this.#quotaTracker.isQuotaCritical(account, modelId, effectiveThreshold);
            if (isQuotaCritical) {
