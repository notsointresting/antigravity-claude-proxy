...
export class HybridStrategy extends BaseStrategy {
    ...
    #getCandidates(accounts, modelId) {
        ...
        for (let index = 0; index < accounts.length; index++) {
            ...
            // At this point, account is usable (not rate-limited, not disabled)
            // So it goes into lastResort
            ...
            // At this point, account has tokens.
            // So it goes into emergency (health check bypassed)
            ...
            // At this point, account is healthy.
            // So it goes into fallback (quota check bypassed)
