...
export class HybridStrategy extends BaseStrategy {
    ...
    selectAccount(accounts, modelId, options = {}) {
        ...
        // Score and track the best candidate in a single pass
        let best = null;
    ...
    #getCandidates(accounts, modelId) {
        ...
        for (let index = 0; index < accounts.length; index++) {
            ...
            // Token check - required for emergency and above
            ...
            // Health check - required for fallback and above
            ...
            // Quota check - required for normal candidates
