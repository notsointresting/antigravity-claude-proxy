...
export class HybridStrategy extends BaseStrategy {
    ...
    selectAccount(accounts, modelId, options = {}) {
        ...
        // Score candidates and find the best one in a single pass
        let best = null;
    ...
    #getCandidates(accounts, modelId) {
        ...
        for (let index = 0; index < accounts.length; index++) {
            ...
            // Usable account, goes into last resort at a minimum
            ...
            // Usable and has tokens, goes into emergency at a minimum
            emergency.push(item);
            ...
            // Usable, has tokens, and healthy, goes into fallback at a minimum
            fallback.push(item);
